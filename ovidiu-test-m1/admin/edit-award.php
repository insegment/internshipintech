  ...
  if (count($_GET) > 0) {
    ...
    if (count($_POST) > 0) {
      ...
      if ($date != '' && $name != '' && $url != '' && $source != '') {
        mysql_query("UPDATE awards SET award_date='$date',name='" . $name ."',url='$url',a_source='" . $source . "' WHERE award_id='$id'");
    ...
    $result = mysql_query("SELECT * FROM awards WHERE award_id='$id'");
    ...
    <div class="col-md-6">
        <div class="box box-info">
          <div class="box-header">
              <h3 class="box-title">Edit Award: <em><?php echo $row['name']; ?></em></h3>
          </div>
          <form method="post" action="" id="edit-article">
            <div class="box-body">
              <div class="form-item item-article-date form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="add_date" name="date" class="form-control" value="<?php echo date("m/d/Y",$row['article_date']); ?>" data-provide="datepicker">
                </div>
              </div>
