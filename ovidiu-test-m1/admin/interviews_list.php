<?php 
  ...
  while($row = mysql_fetch_array($result)) {
    ...
    echo "<tr data-id=" . $row['interview_id'] . " class='interviews'>";
    echo "<td class='date'>" . date('m/d/Y', $row['interview_date']) . "</td>";
    echo "<td class='article'><a href='" . $row['url'] . "' target='_blank'>" . $row['name'] . "</td>";
    echo "<td class='source'> <img src='/". $row['a_source'] . "' width='269' height='161'></td>";
