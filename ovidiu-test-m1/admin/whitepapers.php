...
<section class="content">
    ...
    <div class="col-md-6">
        <div class="box box-info">
          <div class="box-header">
              <h3 class="box-title">Add whitepaper</h3>
          </div>
          <form method="post" action="" id="add-whitepaper">
            <div class="box-body">
            ...
            <div class="form-actions box-footer">
              <input class="btn btn-primary" type="submit" value="Add whitepaper">
            </div>
          </form>
      </div><!-- /.box -->
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">whitepaper</h3>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive no-padding articles-view">
                <table class="table table-hover">
                    ...
                    <?php include('whitepapers_list.php'); ?>
                </tbody></table>
            </div><!-- /.box-body -->
        </div><!-- /.box -->
    </div>
