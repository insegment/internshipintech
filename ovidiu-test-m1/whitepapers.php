				...
				<div class="row">
					<ul class="list">
							<?php foreach ($articles as $article): ?>
								<li><span class="date"><?php echo date('m/d/Y', $article['whitepaper_date']); ?></span><a href="<?php echo $article['url']; ?>" target="_blank"><?php echo $article['name']; ?></a><span class="source"> <a target="_blank" href="<?php echo $article['url']; ?>">Download Whitepaper</a> </span></li>
							<?php endforeach; ?>
						</ul>
				</div>
			</div>
